...
Map<String, Object?> _encodeWeek(TrainingWeek value) => <String, Object?>{
  ...
  'weekStart': value.weekStart.toUtc().toIso8601String(),
  'weekEnd': value.weekEnd.toUtc().toIso8601String(),
  ...
  'items': value.items
      .map(
        (item) => <String, Object?>{
          ...
          'originalDate': item.originalDate.toUtc().toIso8601String(),
          'currentDate': item.currentDate.toUtc().toIso8601String(),
