...
class _WeekDayDetailSheetState extends ConsumerState<WeekDayDetailSheet> {
  ...
  Future<_WeekDayDetail> _load() async {
    ...
    if (raw is! Map) throw StateError('week_item_detail_unavailable');
  ...
  @override
  Widget build(BuildContext context) => FutureBuilder<_WeekDayDetail>(
    future: _future,
...
WorkoutExercise _exercise(Map<String, dynamic> row) => WorkoutExercise(
  id: row['id'] as String,
