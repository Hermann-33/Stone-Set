...
The four Linux dashboard golden candidates were generated by workflow run `31258224871`, visually
reviewed and committed. Open the draft pull request, pass the single path-sensitive final-head CI
run and merge the exact verified head:
