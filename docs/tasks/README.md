...
| `TASK-IMP-010.md` | Implemented; awaiting final-head CI, merge and production deployment | Authoritative base consistency multiplier and Home fixture-leak correction |
