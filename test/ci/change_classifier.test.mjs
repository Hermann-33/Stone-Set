...
test('Vercel dashboard configuration runs dashboard validation without unrelated runtime lanes', () => {
  const result = classifyChanges(['vercel.json', 'tool/vercel/build-dashboard.sh']);
